    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    // Thêm lỗi vào ModelState nếu email không tồn tại
                    ModelState.AddModelError("Email", "Email không tồn tại trong hệ thống.");
                    // Nếu bạn không muốn tiết lộ rằng email không tồn tại, bạn có thể bỏ qua phần này
                ...
                else
                {
                   // Gửi email để reset mật khẩu
                    ...
                    WebBanHangOnline.Common.Common.SendMail("CoCoShop", "Quên mật khẩu", "Bạn click vào <a href='" + callbackUrl + "'>link này</a> để reset mật khẩu", model.Email);
